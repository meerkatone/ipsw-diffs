## h19_ane0_fw_perses_v6x.im4p

> `Firmware/ane/h19_ane0_fw_perses_v6x.im4p`
...
-  __TEXT.__text: 0xc21f8
-  __TEXT.__cstring: 0x1e352
+  __TEXT.__text: 0x9fa04
   __TEXT.__const: 0x4b98
+  __TEXT.__cstring: 0x15a39
   __TEXT.ce_env: 0x4000
-  __TEXT.text_env: 0x20
   __TEXT.__constructor: 0x0
   __TEXT.__init_offsets: 0x0
-  __DATA.__const: 0x7808
+  __TEXT.text_env: 0x20
+  __DATA.__const: 0x77e0
   __DATA._rtk_heap: 0x0
-  __DATA.__data: 0x10c8
+  __DATA.__data: 0xf10
   __DATA._rtk_power: 0x3b8
   __DATA._rtk_patchbay: 0x282
...
-  __DATA.__zerofill: 0x1c5700
-  Functions: 1537
+  __DATA.__gxf_data: 0x10
+  __DATA.__zerofill: 0x1f4000
+  Functions: 1435
   Symbols:   0
-  CStrings:  3571
+  CStrings:  2425
...
- "    sendCnt:%llu recvCnt:%llu\n"
- "    type:%s recvQSize:%u recvCb:%p\n"
...
- "(doorbellNum < mNumDoorbells) && (mDoorbells[doorbellNum] != NULL)"
- "(doorbellNum < mNumDoorbells) && (mDoorbells[doorbellNum] == NULL)"
...
- "(mailboxNum < mNumMailboxes) && (mMailboxes[mailboxNum] != NULL)"
- "(mailboxNum < mNumMailboxes) && (mMailboxes[mailboxNum] == NULL)"
...
- "(physical_layer != NULL) || ((physical_layer == NULL) && apRoute)"
- "(size > 0) && (((uintptr_t)msg + size) <= ((uintptr_t)msgBuffer + msgBufferSize))"
...
- "./ffw/platform/common/CMessageBox.cpp"
- "./ffw/platform/common/ChannelTable.cpp"
- "./ffw/platform/common/FakeChannelTable.cpp"
- "./ffw/platform/perses/rtkit/CPlatformEnvironment.cpp"
- "./ffw/platform/perses/rtkit/CPlatformGPIOManager.cpp"
- "./ffw/platform/perses/rtkit/CPlatformISRManager.cpp"
- "./ffw/platform/perses/rtkit/RealChannelTableTarget.cpp"
...
- "Entry %d"
- "Error: IPCE for TDBASE was kicked before, which is unexpected\n"
...
- "IPCE SCRIPT IBOOT1 index not patched, using default 0x%x"
- "IPCE SCRIPT IBOOT2 index not patched, using default 0x%x"
- "ISR: HW event"
...
- "[PROCEDURE Section] X"
- "[SCR] Mailbox received %llu\n"
- "[SCR] Mailbox sent %llu\n"
...
- "returnRequestId"
- "ringMsgBoxDoorbell"
- "routeNum == RTK_MBI_ROUTE_ID_UNKNOWN"
